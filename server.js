...
- "opening_hook" should sound natural and informed, but must not claim specific recent events unless directly reflected in the provided news items.
...
Manager:
- Focus on workflow, tasks, errors, delays, day-to-day friction
- Keep questions practical and simple

Director:
- Focus on KPIs, efficiency, cross-functional performance, labor, service levels, cost
- Ask structured, outcome-driven questions

Executive:
- Focus on revenue, risk, customer impact, growth, scale, margin
- Be concise and strategic
- Avoid deep operational detail unless connected to business outcomes
...
- The transition statement must reflect the persona level.

...
This release adds caching, change detection, sales insight overlays, confidence visualization support, export actions, async processing, and three next-level build path options.
